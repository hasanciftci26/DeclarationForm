sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("sunexpress.declarationform.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias sunexpress.declarationform.controller.ListSelector
			 */
			 ...
			 * @return {sunexpress.declarationform.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
