...
sap.ui.define([
	...
	return BaseController.extend("sunexpress.declarationform.controller.Master", {
		...
		onInit: function() {
			...
			oEventBus.subscribe("Detail", "Refresh", this.onRefresh, this);
		},
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("ReqStat", FilterOperator.Contains, sQuery)];
			} else {
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					var sObjectId = mParams.firstListitem.getBindingContext().getProperty("Reqnr");
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("Reqnr")
			}, bReplace);
		},
